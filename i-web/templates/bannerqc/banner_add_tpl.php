            ...
            <div class="oneOne">
                ...
                <div class="widget mtop0">
                    ...
                    <?php  foreach ($config['lang'] as $k => $v){
                        ...
                        $duoihinh = $func->getDuoiHinh(_upload_hinhanh.$item["photo_$k"]);
                    ...
                    <?php if($item["photo_$k"]!=''){ ?>

                    <?php if($duoihinh == 'jpg' || $duoihinh=='png' || $duoihinh=='jpeg' || $duoihinh=='gif' || $duoihinh=='svg'){ ?>
                        ...
                        <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                            ...
                            <div class="formRight">
                                <video width="300" height="200" autoplay muted controls>
                                    <source src="<?=_upload_hinhanh.@$item["photo_$k"]?>" type="video/mp4">
                                </video>
                            </div>
                            <div class="clear"></div>
                        </div>

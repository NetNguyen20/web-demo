        ...
        <div class="widget mtop0">
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input  type="text"
                        value="<?=@$timeSlider?>" name="data[time_slider]" title="Nhập địa chỉ link blog" class="conso tipS" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input  type="text"
                        value="<?=@$item['link_blog']?>" name="data[link_blog]" title="Nhập địa chỉ link blog" class="tipS" />
            ...
            <?php if($GLOBAL[$com]['hotline-kythuat']==true) {?>

            <div class="formRow">

                <label>Hotline kỹ thuật</label>

                <div class="formRight">

                    <input 
                        type="text" value="<?=@$item['hotline_kythuat']?>" name="data[hotline_kythuat]" title="Nhập hotline_kythuat"
                        class="tipS" />
    ...
    <div class="colRight">
        ...
        <div class="widget mtop0">
            ...
            <div class="formRow">
                ...
                <label>Phân trang chính sách:</label>
            ...
            <div class="formRow">
                ...
                <label>Phân trang công trình:</label>
            ...
            <?php if($GLOBAL[$com]['page_baogia']==true) {?>

            <div class="formRow">

                <label>Phân trang báo giá:</label>

                <div class="formRight">

                    <input 
                        type="text" name="data[page_baogia]" title="Nhập số item sản phẩm" id="page_baogia" class="tipS"
                        value="<?=@$item['page_baogia']?>" />
            ...
            <?php /* if($GLOBAL[$com]['page_thicong']==true) {?>

            <div class="formRow">

                <label>Phân trang thi công:</label>

                <div class="formRight">

                    <input 
                        type="text" name="data[page_thicong]" title="Nhập số item sản phẩm" id="page_thicong" class="tipS"
                        value="<?=@$item['page_thicong']?>" />
            ...
            <div class="formRow">
                ...
                <label>Phân trang tham khảo:</label>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input 
                        type="text" name="data[page_new]" title="Nhập số item sản phẩm" id="page_new" class="tipS"
                        value="<?=@$item['page_new']?>" />
            ...
            <?php if($GLOBAL[$com]['page_tuyendung']==true) {?>

            <div class="formRow">

                <label>Phân trang tuyển dụng:</label>

                <div class="formRight">

                    <input 
                        type="text" name="data[page_tuyendung]" title="Nhập số item sản phẩm" id="page_tuyendung" class="tipS"
                        value="<?=@$item['page_tuyendung']?>" />
            ...
            <?php if($GLOBAL[$com]['menu_bds']==true) {?>

            <div class="formRow">

                <label for="menu_bds"
                    style="float: left; display: inline-block; width: auto !important; margin-right: 10px;">Menu bất động sản</label>

                <input type="checkbox" name="menu_bds" style="float: left;margin-top:5px;" id="menu_bds" value="1"
                    <?=(!isset($item['menu_bds']) || $item['menu_bds']==1)?'checked="checked"':''?> />
        ...
        <div class="formRow">
            <label>Hình đóng dấu : <span style="color:#f00">(max-width:227px-max-height:227px)</span></label>
        ...
        <div class="formRow">
            ...
            <label>Bật tắt đóng dấu</label>

            <div class="formRight">

                <select name="data[watermark_status]">

                    <option value="1" <?php if($item['watermark_status']==1) echo 'selected'; ?>>Bật</option>

                    <option value="2" <?php if($item['watermark_status']==2) echo 'selected'; ?>>Tắt</option>

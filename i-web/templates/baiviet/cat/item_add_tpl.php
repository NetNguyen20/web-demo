        ...
        <div class="mtop0">
            ...
            <div class="<?=($GLOBAL_LEVEL2[$com][$type]['full']==true) ? 'oneOne':'colRight' ?>">
                <div class="widget mtop0">
                    ...
                    <?php } ?>
                    <?php  foreach ($config['lang'] as $k => $v){ ?>
                    <?php if($GLOBAL_LEVEL2[$com][$type]['motagiaodien']==true){ ?>
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        <label>Mô tả giao diện [<?=$v?>]</label>
                        <div <?php if($GLOBAL_LEVEL2[$com][$type]['motagiaodien-ckeditor']==true) echo 'class="ck_editor"'; ?>>
                            <textarea title="Nhập mô tả . " data-height="400" id="motagiaodien_<?=$k?>"
                                <?php if($GLOBAL_LEVEL2[$com][$type]['motagiaodien-ckeditor']==true) echo 'class="ck_editors"'; ?>
                                name="data[motagiaodien_<?=$k?>]"><?=@$item['motagiaodien_'.$k]?></textarea>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <?php } ?>

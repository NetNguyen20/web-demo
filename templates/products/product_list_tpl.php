                        ...
                        <div class="col l-2-4 m-4 c-6 mb20 mb-t-16 mb-m-8 d-flex flex-column">
                            ...
                            <div class="tea-product__box tea-product__box--category d-flex flex-column flex-cl-1">
                                ...
                                <div class="tea-product__box-img">
                                    ...
                                    <a href="<?=$value["type"]?>/<?=$value["tenkhongdau"]?>" title="<?=$value["ten_$lang"]?>" aria-label="<?=$value["ten_$lang"]?>" role="link" rel="dofollow" class="d-block hover-left ratio-cover ratio-img cubic-img" img-width="4" img-height="3" style="--data-ratio:calc((3 / 4) * 100%);">

                                        <img class="ratio-img__content" src="<?=$imgDefault?>" data-src="<?=_upload_baiviet_l.$value["photo"]?>" alt="<?=$value["ten_$lang"]?>">
                                ...
                                <div class="tea-product__box-detail d-flex flex-column flex-cl-1">
                                    ...
                                    <h2 class="tea-product__box-detail-title line-2 mg0 flex-cl-1 t-center">
                                        ...
                                        <a href="<?=$value["type"]?>/<?=$value["tenkhongdau"]?>" title="<?=$value["ten_$lang"]?>" aria-label="<?=$value["ten_$lang"]?>" role="link" rel="dofollow"><?=$value["ten_$lang"]?></a>
                ...
                <div class="col l-12 m-12 c-12 mt20">
                    ...
                    <div class="res--grid gap20" id="wrap__product">  
                        ...
                        */    
                        ...
                        <?=$func->gridTemplateProduct($tintuc,'res--span--3 res--span--sm6')?>

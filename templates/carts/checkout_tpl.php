							...
							<div class="item10 col-6 w-100-m">
								...
								<div class="row-input">
									...
									<div class="wrap-input">
										...
										<select class="input-select select wrap-input__checkout-city" required name="id_city" id="id_city" onchange="onChangeSelectCart('#id_dist',{id:this.value, fs:'id,name_vi as name, code',fw:'id_city',t:'place/dists',tt:'Chọn quận huyện'})">

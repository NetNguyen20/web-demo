...
<div class="support-main w-100i d-none-m d-none-tablet">
	...
	<div class="container">
		...
		<ul>
            ...
            <li>
                ...
                <a href="tel:<?=str_replace(',','',str_replace('.','',str_replace(' ','',$value["phone"])))?>" title="<?=$value["ten"]?>:<?=$value["phone"]?>">

                    <i class="fa fa-phone" aria-hidden="true"></i>
                    
                    <div style="padding-left:5px"> <?=$value["ten"]?><p><?=$value["phone"]?></p></div>

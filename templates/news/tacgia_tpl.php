<?php
    ...
    $author_post = $db->rawQuery("select ten_$lang as ten,id,id_list,tenkhongdau_$lang as tenkhongdau,type,luotxem,ngaytao,ngaysua from #_baiviet where hienthi=1 and type in ('tin-tuc','cong-trinh','bao-gia','chinh-sach','thiet-ke-thi-cong') and id_tacgia=? order by stt asc,id asc limit 0,4",array($row_detail["id"]));

    $postCount = $db->rawQueryOne("select count(id) as total from #_baiviet where hienthi=1 and type in ('tin-tuc','cong-trinh','bao-gia','chinh-sach','thiet-ke-thi-cong') and id_tacgia=?",array($row_detail["id"]));
    ...
    <div class="grid wide">
        ...
        ?>
            ...
            <div class="<?=$col?>">
                ...
                <div class="breadcumb breadcumb--detail mt20 d-none-m">
                    <?=$str_breadcrumbs?>
                </div>

                ...
                <div class="col l-12 m-12 c-12">
                    ...
                    <div class="row" id="wrap__product">  
                        ...
                        */    
                        ...
                        <?=$func->gridTemplateAlbum($tintuc,'build','col l-4 m-6 c-6 mb20 mb-t-16 mb-m-8 d-flex flex-column','h3','437','334')?>
                    ...
                    <div class="row">
                        ...
                        <div class="col l-12 m-12 c-12 justify-content-center">
                            ...
                            <div id="paging" class="t-center"><?=$func->getLoadMore($total_paging,$per_page,$page,'thư viện')?></div>

                                    ...
                                    <div class="wrappers-news-detail__author-content-socical">
                                        ...
                                        <ul class="wrappers-news-detail__author-content-socical-list d-flex align-items-center">
                                            ...
                                            <li>
                                                ...
                                                <a href="<?=(!empty($row_tacgia["link_facebook"])) ? $row_tacgia["link_facebook"]:'javascript:void(0)'?>" title="Link facebook" rel="nofollow" <?php if(!empty($row_tacgia["link_facebook"])){ ?> target="_blank" <?php }?>>
                                            ...
                                            <li>
                                                ...
                                                <a href="<?=(!empty($row_tacgia["link_zalo"])) ? $row_tacgia["link_zalo"]:'javascript:void(0)'?>" title="Link zalo" rel="nofollow" <?php if(!empty($row_tacgia["link_zalo"])){ ?> target="_blank" <?php }?>>
                                            ...
                                            <li>
                                                ...
                                                <a href="<?=(!empty($row_tacgia["link_instagram"])) ? $row_tacgia["link_instagram"]:'javascript:void(0)'?>" title="Link instagram" rel="nofollow" <?php if(!empty($row_detail["link_instagram"])){ ?> target="_blank" <?php }?>>
                                            ...
                                            <li>
                                                ...
                                                <a href="<?=$row_tacgia["link_twitter"]?>" title="Linh twitter" rel="nofollow" <?php if(!empty($row_tacgia["link_twitter"])){ ?> target="_blank" <?php }?>>

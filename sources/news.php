<?php  if(!defined('_source')) die("Error");
    ...
    if(!empty($idl)){
        ...
        if($row_list){
            ...
            $row_cat = $db->rawQuery("select id,ten_$lang as ten,tenkhongdau_$lang as tenkhongdau,photo,id_list,type,photo,motagiaodien_$lang from #_baiviet_cat where hienthi=1 and type=? and id_list=? order by stt asc",array($type,$row_list["id"]));
                ...
                switch($com){
                    ...
                    case 'san-pham':
                        ...
                        echo json_encode([
                            ...
                            'html' => $func->gridTemplateProduct($tintuc,'res--span--3 res--span--sm6'),
            
                            'paging' => $func->getLoadMore($total_paging,$per_page,$page,'công trình')
                    ...
                    case 'tin-tuc':
                        ...
                        echo json_encode([
                            ...
                            'html' => $func->gridTemplateNews($tintuc,'section','col l-4 m-6 c-12 mb20','h3','416','286'),
            
                            'paging' => $func->getLoadMore($total_paging,$per_page,$page,'tin tức')
    ...
    if(empty($id) && empty($idl) && empty($idc) && empty($idi) && empty($ids)){
        ...
        $row_list = $db->rawQuery("select id,ten_$lang, tenkhongdau_$lang as tenkhongdau,type,photo,motagiaodien_$lang from #_baiviet_list where hienthi=1 and type=? order by stt asc,id desc",array($type));
        ...
        if($func->isAjax()){
            ...
            switch($com){
                ...
                case 'san-pham':
                    ...
                    $getTemplate = $func->gridTemplateProduct($tintuc,'res--span--3 res--span--sm6');
                ...
                case 'tin-tuc':
                    ...
                    $getTemplate = $func->gridTemplateNews($tintuc,'section','col l-4 m-6 c-12 mb20','h3','416','286');
                ...
                default:
                    ...
                    $getTemplate = $func->gridTemplateDefault($tintuc,'tea','col l-6 m-12 c-12 mb20 mb-m-10','h3','600','424');
